...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '薄荷色草地芬芳像风没有形状,我却能够牢记你的气质跟脸庞,冷空气跟琉璃在清晨很有透明感,像我的喜欢被你看穿',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'aircold', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '挣w的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://bolg.aircold.cn', // 网站地址
